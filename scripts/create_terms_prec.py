...
term_urn = make_term_urn("precipitations")
term_properties_aspect = GlossaryTermInfoClass(
    definition="Datasets con precipitaciones.",
    name="Precipitations",
    termSource="",
)
...
rest_emitter = DatahubRestEmitter(gms_server="http://datahub-gms-prec:8080")  # Cambia la URL si tu DataHub está en otro host/puerto
